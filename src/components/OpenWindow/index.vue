<template>
	<transition name="el-fade-in">
		...
		>
			<div
				class="open-select w-11/12 max-w-screen-xl h-5/6 bg-white flex flex-col overflow-x-hidden overflow-y-auto"
			>
				<div
					class="h-10 flex justify-between items-center px-3 shadow-sm border-b border-gray-100"
				>
					<span>{{ title }}</span>
					<div class="cursor-pointer">
						<!--            <el-icon @click='close'><icon-close /></el-icon>-->
					</div>
				</div>
